...
$_['help_registration']        = '<p>Для начала работы модуля, необходимо зарегистрировать бота (который будет отправлять уведомления) и получить его уникальный идентификатор, одновременно являющийся и токеном. Для этого в Telegram существует специальный бот — <a href="https://telegram.me/botfather" target="_blank">@BotFather</a>.</p>
...
<p>Webhook нужен для того что бы бот смог сообщить идентификатор вашего чата с вашим ботом именно для его работы обязательно иметь SSL</p>
